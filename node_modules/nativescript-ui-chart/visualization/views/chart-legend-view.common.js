...
var RadLegendView = /** @class */ (function (_super) {
    ...
    RadLegendView.positionProperty = new view_1.Property({
        ...
        valueConverter: function (value) { return chart_public_enum_1.ChartLegendPosition[chart_public_enum_1.toPascalCase(value)]; },
        valueChanged: function (target, oldValue, newValue) {
    ...
    RadLegendView.offsetOriginProperty = new view_1.Property({
        ...
        valueConverter: function (value) { return chart_public_enum_1.ChartLegendOffsetOrigin[chart_public_enum_1.toPascalCase(value)]; },
        valueChanged: function (target, oldValue, newValue) {
