...
var chart_label_style_common_1 = require("../parts/chart-label-style.common");
var font_1 = require("tns-core-modules/ui/styling/font");
var chart_axis_common_1 = require("./chart-axis.common");
var color_1 = require("tns-core-modules/color");
var ui_chart_common_1 = require("../../ui-chart.common");
var ChartSeries = /** @class */ (function (_super) {
    __extends(ChartSeries, _super);
    function ChartSeries() {
        return _super.call(this) || this;
    }
    ChartSeries.prototype.initNativeView = function () {
    };
    ChartSeries.prototype.eachChild = function (callback) {
        if (this._label) {
            callback(this._label);
        }
    };
    ChartSeries.prototype.onLoaded = function () {
        var _this = this;
        if (!this._label) {
            var label = new ChartSeriesLabel();
            this._label = label;
            ui_chart_common_1.setupCssScope(this.owner, this._label);
            this._addView(this._label);
        }
        if (!this.labelStyle) {
            this.labelStyle = new chart_label_style_common_1.PointLabelStyle();
        }
    ...
    Object.defineProperty(ChartSeries.prototype, "label", {
        get: function () {
            return this._label;
        },
        enumerable: true,
    ...
    ChartSeries.prototype.updateLabelColorFromStyle = function () {
        var labelTextColor = this._label.style.color;
        if (labelTextColor !== undefined) {
            this.labelStyle.textColor = labelTextColor;
        }
    };
    ChartSeries.prototype.updateLabelFontFromStyle = function () {
        var fontInternal = this._label.style.fontInternal;
        if (fontInternal && fontInternal !== font_1.Font.default) {
            this.initializer.onFontInternalChanged(null, fontInternal, this);
        }
    };
    ChartSeries.prototype.updateLabelMarginFromStyle = function () {
        var labelMargin = this._label.style.marginLeft;
        if (labelMargin !== undefined && !isNaN(+labelMargin)) {
            this.labelStyle.margin = +labelMargin;
        }
    };
    ChartSeries.prototype.updateLabelFillColorFromStyle = function () {
        var labelFillColor = this._label.style.backgroundColor;
        if (labelFillColor !== undefined) {
            this.labelStyle.fillColor = labelFillColor;
        }
    };
    ChartSeries.prototype.updateLabelStrokeWidthFromStyle = function () {
        var labelStrokeWidth = this._label.style.borderLeftWidth;
        if (labelStrokeWidth !== undefined && !isNaN(+labelStrokeWidth)) {
            this.labelStyle.strokeWidth = +labelStrokeWidth;
        }
    };
    ChartSeries.prototype.updateLabelStrokeColorFromStyle = function () {
        var labelStrokeColor = this._label.style.borderLeftColor;
        if (labelStrokeColor !== undefined) {
            this.labelStyle.strokeColor = labelStrokeColor;
        }
    };
    ChartSeries.prototype.updateLabelFormatFromStyle = function () {
        var labelFormat = this._label.format;
        if (labelFormat !== undefined) {
            this.labelStyle.textFormat = labelFormat;
        }
    };
    ChartSeries.prototype.updateLabelPaddingFromStyle = function (propertyName) {
        this.initializer.onLabelPaddingChanged(null, propertyName, this);
    };
    ChartSeries.prototype.applyLabelPropertyFromStyle = function (propertyName) {
    ...
    ChartSeries.prototype.attachLabelChangeListeners = function () {
    ...
    ChartSeries.prototype.detachLabelChangeListeners = function () {
    ...
    ChartSeries.prototype.onUnloaded = function () {
    ...
    ChartSeries.selectionModeProperty = new view_1.Property({
        ...
        valueConverter: function (value) { return chart_public_enum_1.ChartSeriesSelectionMode[chart_public_enum_1.toPascalCase(value)]; },
...
var CartesianSeries = /** @class */ (function (_super) {
    ...
    Object.defineProperty(CartesianSeries.prototype, "owner", {
        get: function () {
            return this._owner;
        },
        set: function (value) {
    ...
    CartesianSeries.prototype.onFillColorPropertyChanged = function (oldValue, newValue) {
        this.onFillColorChanged(oldValue, newValue);
    };
    CartesianSeries.prototype.onStrokeWidthPropertyChanged = function (oldValue, newValue) {
        this.onStrokeWidthChanged(oldValue, newValue);
    };
    CartesianSeries.prototype.onStrokeColorPropertyChanged = function (oldValue, newValue) {
        this.onStrokeColorChanged(oldValue, newValue);
    };
    CartesianSeries.prototype.onFillColorChanged = function (oldValue, newValue) {
        this.initializer.onFillColorChanged(oldValue, newValue, this);
    };
    CartesianSeries.prototype.onStrokeWidthChanged = function (oldValue, newValue) {
        this.initializer.onStrokeWidthChanged(oldValue, newValue, this);
    };
    CartesianSeries.prototype.onStrokeColorChanged = function (oldValue, newValue) {
    ...
    CartesianSeries.paletteModeProperty = new view_1.Property({
        name: 'paletteMode',
        defaultValue: undefined,
        valueConverter: function (value) { return chart_public_enum_1.ChartSeriesPaletteMode[chart_public_enum_1.toPascalCase(value)]; },
        valueChanged: function (target, oldValue, newValue) {
            target.onPaletteModeChanged(oldValue, newValue);
        }
    });
    CartesianSeries.fillColorProperty = new view_1.Property({
        name: "fillColor",
        defaultValue: undefined,
    ...
    CartesianSeries.strokeWidthProperty = new view_1.Property({
        name: "strokeWidth",
        defaultValue: undefined,
    ...
    CartesianSeries.strokeColorProperty = new view_1.Property({
        name: "strokeColor",
        defaultValue: undefined,
        equalityComparer: color_1.Color.equals,
        valueConverter: function (v) { return new color_1.Color(v); },
...
var CategoricalSeries = /** @class */ (function (_super) {
    ...
    CategoricalSeries.stackModeProperty = new view_1.Property({
        ...
        valueConverter: function (value) { return chart_public_enum_1.ChartSeriesStackMode[chart_public_enum_1.toPascalCase(value)]; },
        valueChanged: function (target, oldValue, newValue) {
...
var OhlcSeries = /** @class */ (function (_super) {
    ...
    OhlcSeries.prototype.onStrokeColorsPropertyChanged = function (oldValue, newValue) {
    ...
    OhlcSeries.prototype.onStrokeColorsChanged = function (oldValue, newValue) {
    ...
    OhlcSeries.strokeColorsProperty = new view_1.Property({
        name: "strokeColors",
        defaultValue: undefined,
        valueConverter: function (v) { return v.split(",").map(function (v1) { return new color_1.Color(v1); }); },
        valueChanged: function (target, oldValue, newValue) {
            target.onStrokeColorsPropertyChanged(oldValue, newValue);
        },
    });
    OhlcSeries = __decorate([
        view_1.CSSType("OhlcSeries")
    ], OhlcSeries);
    return OhlcSeries;
}(CategoricalSeries));
...
var CandlestickSeries = /** @class */ (function (_super) {
    ...
    CandlestickSeries = __decorate([
        view_1.CSSType("CandlestickSeries")
    ], CandlestickSeries);
...
var PieSeries = /** @class */ (function (_super) {
    ...
    Object.defineProperty(PieSeries.prototype, "owner", {
        get: function () {
            return this._owner;
        },
        set: function (value) {
    ...
    PieSeries.prototype.onFillColorsPropertyChanged = function (oldValue, newValue) {
        this.onFillColorsChanged(oldValue, newValue);
    };
    PieSeries.prototype.onStrokeWidthPropertyChanged = function (oldValue, newValue) {
        this.onStrokeWidthChanged(oldValue, newValue);
    };
    PieSeries.prototype.onStrokeColorsPropertyChanged = function (oldValue, newValue) {
        this.onStrokeColorsChanged(oldValue, newValue);
    };
    PieSeries.prototype.onFillColorsChanged = function (oldValue, newValue) {
        this.initializer.onFillColorsChanged(oldValue, newValue, this);
    };
    PieSeries.prototype.onStrokeWidthChanged = function (oldValue, newValue) {
        this.initializer.onStrokeWidthChanged(oldValue, newValue, this);
    };
    PieSeries.prototype.onStrokeColorsChanged = function (oldValue, newValue) {
        this.initializer.onStrokeColorsChanged(oldValue, newValue, this);
    };
    ...
    PieSeries.fillColorsProperty = new view_1.Property({
        name: "fillColors",
        defaultValue: undefined,
        valueConverter: function (v) { return v.split(",").map(function (v1) { return new color_1.Color(v1); }); },
        valueChanged: function (target, oldValue, newValue) {
    ...
    PieSeries.strokeWidthProperty = new view_1.Property({
        name: "strokeWidth",
        defaultValue: undefined,
        valueConverter: parseFloat,
        valueChanged: function (target, oldValue, newValue) {
    ...
    PieSeries.strokeColorsProperty = new view_1.Property({
        name: "strokeColors",
        defaultValue: undefined,
        valueConverter: function (v) { return v.split(",").map(function (v1) { return new color_1.Color(v1); }); },
        valueChanged: function (target, oldValue, newValue) {
...
var ScatterBubbleSeries = /** @class */ (function (_super) {
    ...
    ScatterBubbleSeries = __decorate([
        view_1.CSSType("ScatterBubbleSeries")
    ], ScatterBubbleSeries);
...
var ChartSeriesLabel = /** @class */ (function (_super) {
    __extends(ChartSeriesLabel, _super);
    function ChartSeriesLabel() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ChartSeriesLabel.formatProperty = new view_1.Property({
        name: "format",
        valueConverter: function (v) { return chart_axis_common_1.trimQuotes(v); }
    });
    ChartSeriesLabel = __decorate([
        view_1.CSSType("ChartSeriesLabel")
    ], ChartSeriesLabel);
    return ChartSeriesLabel;
}(view_1.View));
exports.ChartSeriesLabel = ChartSeriesLabel;
